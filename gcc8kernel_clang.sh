...
clear
echo "#########################################"
echo "## PHANTOM Kernel - CLANG Build Script ##"
echo "#########################################"
...
make -j$(nproc --all) O=out \
                      ...
                      CROSS_COMPILE=$PHANTOM_WORKING_DIR/aarch64-linux-android-opt-gnu-8.x/bin/aarch64-opt-linux-android-
...
cp $KERNEL_DIR/out/arch/arm64/boot/Image.gz-dtb $KERNEL_DIR/AnyKernel2
